        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td>${list.salary}</td>
                    <td>
                        <a href="/edit.htm?id={employee.id}" class="fa fa-edit btn btn-default" >Edit</a>
                        <a href="/delete.htm?id={employee.id}" class="fa fa-trash btn btn-danger"
                         onclick="return comfirm('Do you want to remove this employee?')" >Delete</a>
                    </td>
                </tr>
            </tbody>
        </table>
